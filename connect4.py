...
def winning_move (board, piece):
   #Check for a Horizontal 4
   for c in range(COL_COUNT-3):
      for r in range(ROW_COUNT):
         if board[r][c] == piece and board[r][c+1] == piece and board[r][c+2] == piece and board[r][c+3] == piece:
            return True

   #Check for a Vertical 4
   for c in range(COL_COUNT):
      for r in range(ROW_COUNT - 3):
         if board[r][c] == piece and board[r+1][c] == piece and board[r+2][c] == piece and board[r+3][c] == piece:
            return True

   #Check for positive diagonal 4
   for c in range(COL_COUNT-3):
      for r in range(ROW_COUNT - 3):
         if board[r][c] == piece and board[r+1][c+1] == piece and board[r+2][c+2] == piece and board[r+3][c+3] == piece:
            return True

   #Check for negative diagonal 4
   for c in range(COL_COUNT-3):
      ...
      if turn == 0:
         ...
         if is_valid_location(board, col):
            ...
            if winning_move(board, 1):
               label = myfont.render("Player 1 Wins!!!!! Congrats !!!")
               game_over = True
      ...
      #Request Player 2 input 
         ...
         if is_valid_location(board, col):
            ...
            if winning_move(board, 2):
                  label = myfont.render("Player 2 Wins!!!!! Congrats !!!")
                  game_over = True
